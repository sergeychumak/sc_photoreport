<template>
  <div class="app__page">
    ...
    <div class="app__subHeader">
      <v-toolbar height="40" color="white" class="elevation-1">
        ...
        <v-toolbar-items>
          ...
          <v-btn class="green--text" flat @click="dialog_addUser = true"><span class="caption">Создать</span></v-btn>
        </v-toolbar-items>
      </v-toolbar>
    </div>
    ...
    <v-dialog v-model="dialog_addUser" persistent scrollable max-width="600">
      <addUser
        v-on:close-dialog="__closeDialog_addUser"
        v-on:save-dialog="__saveDialog_addUser"
      ></addUser>
    </v-dialog>
...
export default {
  ...
  methods: {
    ...
    __saveDialog_addUser: function (data) {
      console.log(data)
    },
    __closeDialog_addUser: function () {
