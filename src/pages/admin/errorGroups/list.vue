<template>
  <div class="vApplication__page">
    ...
    <div ref="isHook__Name">
      / {{$t('CONTROL.LABEL').toUpperCase()}} / {{$t('CONTROL.ERROR_GROUPS').toUpperCase()}}
    </div>
...
<script>
  ...
  export default {
    ...
    data () {
      const key = "point.location"
      const keyLang = "error_groups"
      return {
        key: key,
        nameKeySelected: 'id',
        headers: [
          {id: 'labelRu', text: this.$t('TABLE.' + keyLang.toUpperCase()          + '.name' )},
          {id: 'labelEn', text: this.$t('TABLE.' + keyLang.toUpperCase()          + '.name_en' )},
          {id: 'labelZh', text: this.$t('TABLE.' + keyLang.toUpperCase()          + '.name_zh' )},
          {id: 'businessText', text: this.$t('TABLE.' + keyLang.toUpperCase()         + '.business' )},
