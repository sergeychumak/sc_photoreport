<template>
  <v-layout>
    ...
    <div class="isHook">
      ...
      / {{$t('CONTROL.LABEL').toUpperCase()}} / {{$t('CONTROL.PHOTO_CATEGORIES').toUpperCase()}}
    </div>
    </div>
...
<script>
  ...
  export default {
    name: 'admin-category-photo-page',
    ...
    computed: {
      ...
      headers: function(){
        return [
          {id: 'name', text: this.$t('TABLE.' + this.key.toUpperCase()            + '.name' )},
          {id: 'name_en', text: this.$t('TABLE.' + this.key.toUpperCase()         + '.name_en' )},
          {id: 'name_zh', text: this.$t('TABLE.' + this.key.toUpperCase()         + '.name_zh' )},
          {id: 'businessAlias', text: this.$t('TABLE.' + this.key.toUpperCase()   + '.businessAlias' )},
          {id: 'countryAlias', text: this.$t('TABLE.' + this.key.toUpperCase()    + '.countryAlias' )},
          {id: 'category0Alias', text: this.$t('TABLE.' + this.key.toUpperCase()  + '.category0Alias' )}
        ]
      }
